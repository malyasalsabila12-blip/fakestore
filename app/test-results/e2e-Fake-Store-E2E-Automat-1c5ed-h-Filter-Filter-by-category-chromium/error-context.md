...
Expected substring: "SanDisk"
Received string:    "WD 2TB Elements Portable External Hard Drive - USB 3.0 $64electronicsDetailsAdd to Cart"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('[data-test^="product-card-"]').first()
    14 × locator resolved to <div data-test="product-card-9" class="border p-4 rounded-lg shadow hover:shadow-xl transition-all bg-white flex flex-col h-full group">…</div>
       - unexpected value "WD 2TB Elements Portable External Hard Drive - USB 3.0 $64electronicsDetailsAdd to Cart"

```

```yaml
- img "WD 2TB Elements Portable External Hard Drive - USB 3.0"
- heading "WD 2TB Elements Portable External Hard Drive - USB 3.0" [level=2]
- paragraph: $64
- text: electronics
- link "Details":
  - /url: /product/9
...
```ts
  ...
  4   | 
  5   | test.describe('Fake Store E2E Automation (POM)', () => {
