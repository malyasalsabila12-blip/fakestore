  ...
  return (
    <div className="fixed bottom-32 right-8 z-50">
      <a 
        ...
        className="flex items-center gap-3 rounded-full bg-black px-6 py-3 text-white shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 group border border-white/10"
      >
